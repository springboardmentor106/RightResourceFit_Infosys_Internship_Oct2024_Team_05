      ...
      <div className="content">
        ...
        {selectedJob && (
          <div className="selected-job-card">
            ...
            <p className="salary"><strong>Salary:</strong> {selectedJob.salary}</p>
            <p className="rating"><strong>Rating:</strong> {selectedJob.rating}</p>
            {selectedJob.verified && <p className="verified">This job is verified.</p>}
          </div>
        )}
